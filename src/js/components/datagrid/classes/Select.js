...
class Select {
    ...
    create() {
        ...
        if (this.label && this.label.position === "left") {
        ...
        if (this.label && this.label.position === "right") {
            this.field.appendChild(this.labelEl);
        }
    ...
    createAdornment() {
        ...
        const iconButton = new IconButton({
            ...
            buttonSize: "medium",
            svgSize: "xs",
            icon: icons.get("caret-down-fill"),
    ...
    handleFocus() {
        this.selectEl.focus();
        this.customSelect.classList.add("focus");
    }

    handleBlur() {
        this.selectEl.blur();
        this.customSelect.classList.remove("focus");
    }
    ...
    position() {
        ...
        this.customOptions.firstChild.style.width = rect.width + "px";
    }
    ...
    findOption(key) {
        ...
        for (let i = 0; i < this.options.length; i++) {
            ...
            const text = option[this.option.text].toString().toLowerCase();
